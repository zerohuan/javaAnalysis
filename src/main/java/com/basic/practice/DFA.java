...
public class DFA {
	...
	private static final String WORDS_TABLE = "/home/nju/files/sensitive_words.txt";
    static {
    	try {
    		keyMap = new HashMap<Character, SingleChar>();
			String txt = IOUtils.toString(new FileInputStream(WORDS_TABLE), StandardCharsets.UTF_8);
			if(txt != null) {
				//加载过滤词表
				loadKeywords(txt, ",");
			}
	 ...
	 * @param separator
	 */
	public static void loadKeywords(String keyStr, String separator) {
    ...
    public static void main(String[] args) {
        String txt = "安局办公楼你好中国把学生人大主任我真是需要办理资格，他练过法轮功我不是骗人的安局办公楼安局办公楼安局办";
